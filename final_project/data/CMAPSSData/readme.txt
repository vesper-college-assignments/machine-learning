...
//The goal is to predict if will the engine fail in the next X cycles
//That makes it a binary classification problem
// I have to find out the information of when the failure occurs, calculate the efective nº of cycles until failure
// Then create a bool column
...
// where is the information of the failure?
// If I find this 
